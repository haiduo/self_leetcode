...
label = {"accident":10, "fire":11, "dense_traffic":12, "chemicals_vehicle":13, "bus":8, "road_toss":15}

base_dir = r"C:\Users\haidu\Desktop\temp\target"
...
def mixup(name_background, name_background_mask, target_batch, n_holes, batch, dest_annotation_dir, alpha=1.0):
    ...
    for _ in range(n_holes):
        ...
        scale_pixel = np.random.randint(np.floor(0.2 * w_target))
...
if __name__ == '__main__':
    imagedir_target = r'C:\Users\haidu\Desktop\temp\target'  # source images
    imagedir_background = r'C:\Users\haidu\Desktop\temp\wide_road'
    imagedir_background_mask = r"C:\Users\haidu\Desktop\temp\road_label"

    dest_image_dir = r'C:\Users\haidu\Desktop\temp\cutmix_picture\test\images'  # images saved here
    dest_annotation_dir = r"C:\Users\haidu\Desktop\temp\cutmix_picture\test\annotations"
    # 遍历指定目录，显示目录下的所有文件名
    ...
    for i in range(3):
        for background in pathDir_background:
